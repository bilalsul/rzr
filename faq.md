...
Use the built-in Zip Manager to download a repository from GitHub, GitLab or Bitbucket, or import a `.zip` archive that you already have on your device. The repository is extracted and added to your projects, where you can open it from the home screen.
<br/><br/>
